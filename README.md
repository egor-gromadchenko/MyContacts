...
Після створення папки `screenshots` у репозиторії можна додати скріншоти за такими шляхами:
...
> Додайте сюди посилання на GitHub-репозиторій після його завантаження.
